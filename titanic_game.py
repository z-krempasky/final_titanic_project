...
def getOutro(name,gender,cabin,age, siblings,children,status,passenger_crew,crew_pos):
    if status==dead and gender=="Male":
    ...
    elif status==dead and gender=="Male" and cabin=="First Class" and children>0:
    ...
    elif status==dead and gender=="Female" and passenger_crew=="Crew" and crew_pos=="Deck Hand":
    ...
    elif status==dead and gender=="Male" and children>0 and cabin !="First Class":
    ...
    elif status==alive and gender=="Female" and children==1:
    ...
    elif status==alive and gender=="Male" and age<=10:
    ...
    elif status==dead and siblings==1 and gender=="Female":
    ...
    elif status ==dead and siblings==1 and gender=="Male":
    ...
    elif status==dead and gender=="Male" and children==2:
    ...
    elif status==dead and gender=="Male" and crew_pos=="Engineering Crew":
    ...
    elif status==alive and gender=="Female" and children==2:
    ...
    elif status==dead and gender=="Male" and crew_pos=="Restaurant Staff":
    ...
    elif status==dead and crew_pos=="Deck Hand":
    ...
    elif status==alive and crew_pos=="Deck Hand":
    ...
    elif status==alive and gender=="Female" and children==0:
